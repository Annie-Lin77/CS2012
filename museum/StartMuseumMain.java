...
public class StartMuseumMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// every time your program survives another call to a class or method, your// score increases.
			score = score + 5;
			...
			Dinasaurs dino_1 = new Dinasaurs("Tyranasaurus Rex", "Bipedal with tail", "Armored mechanical battle dinasaur with machinegun,used in WW2", "1945");
			score = score + 5;
			...
			MedievalArmor armor_1 = new MedievalArmor("King Charlemane Gold Plated Armor", "King Charlemane", false, false, "Full suit of battle ready plate armor","1066", "plate armor");
			score = score + 5;
			...
			armor_2.setDescription("This type of shield was weak against Ballista, as can be seen by the large hole in it that killed Prince John");
		...
		score = score + 10;
		// * note - checking the output to see that the toString() methods have been// configured
		// Up to 9 points off if it gives the Object.toString() defaultoutput. 
		// 3 points off for each class that does not implement it).
		...
		System.out.println("\nThank you " + happyVisitor.getName()+ " for visiting the Museum.\nLooking forward to seeing you again in the future!");
		}
			catch (Exception e) {
